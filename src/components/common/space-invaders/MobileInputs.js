...
import {Control, Ellipse, Line} from "@babylonjs/gui";
...
export class MobileInputs {
  ...
  drawJoystick(texture) {
    ...
    thumbContainer.onPointerUpObservable.add((_coordinates) => {
      joystickX = 0;
      joystickY = 0;
      this.left = this.right = false;
      puck.isDown = false;
  ...
  makeThumbArea(name, thickness, color, background, _curves) {
