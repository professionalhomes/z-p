...
export interface RouterSwapTokensForExactTokensArgs {
    amount_out: i128,
    amount_in_max: i128,
    path: Address[] | string[],
    to: Address | string,
...
export interface RouterGetAmountOutArgs {
    amount_in: i128,
    path: Address[] | string[],
}

export interface RouterGetAmountInArgs {
    amount_out: i128,
    path: Address[] | string[],
}

export interface RouterPairForArgs {
    token_a: Address | string,
    token_b: Address | string,
}

export class RouterContract extends Contract {
    static spec: ContractSpec = new ContractSpec([
        "AAAAAQAAAAAAAAAAAAAAEEluaXRpYWxpemVkRXZlbnQAAAABAAAAAAAAAAdmYWN0b3J5AAAAABM=",
    ...
    static readonly parsers = {
        addLiquidity: () => { },
        swapExactTokensForTokens: (result: string): Option<i128[]> => RouterContract.spec.funcResToNative('swap_exact_tokens_for_tokens', result),
        swapTokensForExactTokens: (result: string): Option<i128[]> => RouterContract.spec.funcResToNative('swap_tokens_for_exact_tokens', result),
        routerGetAmountIn: (result: string): Option<i128[]> => RouterContract.spec.funcResToNative('router_get_amounts_in', result),
        routerGetAmountOut: (result: string): Option<i128[]> => RouterContract.spec.funcResToNative('router_get_amounts_out', result),
        routerPairFor: (result: string): Option<string> => RouterContract.spec.funcResToNative('router_pair_for', result)
    };

    addLiquidity(contractArgs: RouterAddLiquidityArgs) {
        return this.call(
            'add_liquidity',
            ...RouterContract.spec.funcArgsToScVals('add_liquidity', contractArgs)
        ).toXDR('base64');
    }

    swapExactTokensForTokens(contractArgs: RouterSwapExactTokensForTokensArgs) {
        return this.call(
            'swap_exact_tokens_for_tokens',
            ...RouterContract.spec.funcArgsToScVals('swap_exact_tokens_for_tokens', contractArgs)
        ).toXDR('base64');
    }

    swapTokensForExactTokens(contractArgs: RouterSwapTokensForExactTokensArgs) {
        return this.call(
            'swap_tokens_for_exact_tokens',
            ...RouterContract.spec.funcArgsToScVals('swap_tokens_for_exact_tokens', contractArgs)
        ).toXDR('base64');
    }

    routerGetAmountsIn(contractArgs: RouterGetAmountInArgs) {
        return this.call(
            'router_get_amounts_in',
            ...RouterContract.spec.funcArgsToScVals('router_get_amounts_in', contractArgs)
        ).toXDR('base64');
    }

    routerGetAmountsOut(contractArgs: RouterGetAmountOutArgs) {
        return this.call(
            'router_get_amounts_out',
            ...RouterContract.spec.funcArgsToScVals('router_get_amounts_out', contractArgs)
        ).toXDR('base64');
    }

    routerPairFor(contractArgs: RouterPairForArgs) {
        return this.call(
            'router_pair_for',
            ...RouterContract.spec.funcArgsToScVals('router_pair_for', contractArgs)
        ).toXDR('base64');
    }
}